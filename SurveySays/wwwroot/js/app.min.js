...
</div>`}});hostRoutes.push({path:":groupId/:surveyId",component:{beforeRouteEnter:function(n,t,i){var r="/host",u=[0,breadcrumbs.length,{text:"Home",url:"/"},{text:"Host",route:r},{text:n.params.groupId,route:r+="/"+encodeURIComponent(n.params.groupId)},{active:!0,text:"Survey"}];breadcrumbs.splice.apply(breadcrumbs,u);i(t=>t.loadSurvey(n.params.groupId,n.params.surveyId))},beforeRouteUpdate:function(n,t,i){this.loadSurvey(n.params.groupId,n.params.surveyId);i()},data:function(){return{currentAnswer:null,editAnswer:null,editQuestion:"",groupId:null,questionProblem:null,surveyId:null,survey:null,surveyProblem:null}},methods:{answerClick:function(n){if(!n.$event.target||n.$event.target.tagName!="INPUT"){var i=this,t=n.answer;i.isEdit(t)||(i.editAnswer={$o:{score:t.score||0,text:t.text||""},$src:t,score:t.score||0,text:t.text||""});i.$nextTick(function(){$("#survey_answer_"+n.index+" input").first().focus()})}},answerDelete:function(n,t){this.survey.answers.splice(t,1);this.saveSurvey()},answerKeyDown:function(n){var t=this,e=n.$event,i=t.survey.answers,r,u,f;switch(e.key){case"ArrowDown":r=i[u=n.index+1];break;case"ArrowUp":r=i[u=n.index-1];break;case"Home":case"PageUp":r=i[u=0];break;case"End":case"PageDown":r=i[u=i.length-1];break;case"Enter":if(t.isEdit(n.answer)){t.editAnswer=null;$(e.target).closest("li").focus();return}t.answerClick(n);break;case" ":if(t.isEdit(n.answer))return;t.answerClick(n);break;case"Backspace":case"Delete":if(t.isEdit(n.answer))return;t.answerDelete(e,n.index);r=i[u=n.index]||i[u=n.index-1];break;case"Escape":if(f=t.isEdit(n.answer),f)f.$src.text=f.$o.text,f.$src.score=f.$o.score,t.editAnswer=null,t.answerSort();else return;default:return}e.preventDefault();r&&(t.currentAnswer=r,t.$nextTick(function(){$("#survey_answer_"+u).focus()}))},answerSort:function(){this.survey&&this.survey.answers.sort(function(n,t){var i=n.score,r=t.score;return i<r?1:i>r?-1:(i=n.text.toLowerCase(),r=t.text.toLowerCase(),i<r)?-1:i>r?1:0})},isEdit:function(n){var t=this.editAnswer;return t&&t.$src==n?t:null},loadSurvey:function(n,t){var i=this;(n!=i.groupId||t!=i.surveyId)&&(i.survey=null,apiService.loadSurvey(i.groupId=n,i.surveyId=t).then(n=>{i.survey=n,i.currentAnswer=n.answers[0]},n=>i.surveyProblem=n||"Invalid survey"))},questionEdit:function(n){this.editQuestion=this.survey.question||"";n.preventDefault()},questionSave:function(){var n=this;if(n.editQuestion&&(n.questionProblem=0,n.survey.question!=n.editQuestion)){n.survey.question=n.editQuestion;n.saveSurvey().then(()=>{$("#question_modal").modal("hide"),n.questionProblem=null},t=>n.questionProblem=t||"There was a problem saving the question.");return}$("#question_modal").modal("hide")},saveSurvey:function(){return apiService.saveSurvey(this.survey)}},template:`<div class="container">
	<h2>Survey</h2>
	<div v-if="survey">
		<div class="game">
