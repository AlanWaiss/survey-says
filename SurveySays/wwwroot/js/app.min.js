...
</li>`});Vue.component("survey-board",{props:["answers","selected"],methods:{answerClick:function(n){this.$emit("answer-click",n)},isSelected:function(n){var t=this.selected;return t?t.find(t=>t&&t.text==n.text):!1}},template:`<ol class="survey-board list-unstyled">
