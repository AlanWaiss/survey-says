function fetchJson(n,t){return fetch(n,t).then(n=>{if(!n.ok){console.error("Invalid response",n);throw new Error(404==n.status?"Not found":"Invalid response");}return n.json()})}const apiService={root:"/api",loadGames:function(n,t){return fetchJson(this.root+"/game/"+encodeURIComponent(n)+"?survey="+encodeURIComponent(t),{credentials:"same-origin"})},loadSurvey:function(n,t){return fetchJson(this.root+"/survey/"+encodeURIComponent(n)+"/"+encodeURIComponent(t),{credentials:"same-origin"})},saveGame:function(n){var t=this.root+"/game/"+encodeURIComponent(n.groupId),i="POST";return n.id&&(t+="/"+encodeURIComponent(n.id),i="PUT"),fetchJson(t,{method:i,cache:"no-cache",credentials:"same-origin",headers:{"Content-Type":"application/json"},redirect:"follow",referrerPolicy:"no-referrer",body:JSON.stringify(n)})},saveSurvey:function(n){var t=this.root+"/survey/"+encodeURIComponent(n.groupId),i="POST";return n.id&&(t+="/"+encodeURIComponent(n.id),i="PUT"),fetchJson(t,{method:i,cache:"no-cache",credentials:"same-origin",headers:{"Content-Type":"application/json"},redirect:"follow",referrerPolicy:"no-referrer",body:JSON.stringify(n)})}},_debug=1,CONNECTION_STATUS={Connected:1,Disconnected:0,Pending:2,Trouble:9},gameHub=(new signalR.HubConnectionBuilder).withUrl("/gameHub").withAutomaticReconnect().build();(function(){function n(t,f){n.timer||window.closing||(n.timer=setTimeout(function(){i().then(t,f)},u[n.attempt]||r),n.attempt++,console.log("Reconnecting (attempt "+n.attempt+")..."))}function i(){return n.timer=0,new Promise((i,r)=>{"Connected"==gameHub.state?i(gameHub):"Disconnected"!=gameHub.state&&t?t.then(i,r):t=gameHub.start().then(function(){n.attempt=0;i(gameHub)},function(t){console.error("Connection problem",t);n(i,r)})})}const r=1e4,u=[300,600,1500,3e3];gameHub.onclose(function(t){_debug&&console.log("gameHub connection closed",t);n()});gameHub.onreconnected(function(n){_debug&&console.log("gameHub reconnected",n)});gameHub.onreconnecting(function(n){_debug&&console.log("gameHub reconnecting",n)});n.attempt=0;n.timer=0;var t;window.startHubAsync=i})();const routes=[],user={id:"",name:""},breadcrumbs=[];Vue.component("breadcrumb-nav",{data:function(){return{items:breadcrumbs}},template:`<nav aria-label="breadcrumb" id="breadcrumb" style="display:none" v-show="items.length > 0">
	<ol class="breadcrumb">
...
</div>`}});hostRoutes.push({path:":groupId/:surveyId/:gameId",component:{beforeRouteEnter:function(n,t,i){i(t=>t.loadData(n.params.groupId,n.params.surveyId,n.params.gameId))},beforeRouteUpdate:function(n,t,i){this.loadData(n.params.groupId,n.params.surveyId,n.params.gameId);i()},beforeRouteLeave:function(n,t,i){this.disconnect();i()},computed:{gameUrl:function(){return window.location.origin+"/play/"+encodeURIComponent(this.$route.params.groupId)+"/"+encodeURIComponent(this.$route.params.gameId)}},data:function(){return{gameId:null,groupId:null,surveyId:null,game:null,survey:null,surveyProblem:null}},methods:{answerClick:function(n){var t=this,i;t.game&&t.survey&&(i=$.extend(!0,{},t.game),i.answers[n.index]=$.extend({},n.answer),gameHub.send("GameUpdate",i))},connect:function(n,t){var i=this;i.disconnect();gameHub.on("gameUpdate",this.c_gameUpdate=n=>{i.game=n,n.name&&(breadcrumbs[breadcrumbs.length-1].text=n.name)});i.c_groupId=n;i.c_gameId=t;startHubAsync().then(function(){gameHub.send("joinGame",{groupId:n,id:t})})},disconnect:function(){var n=this;n.c_gameUpdate&&(gameHub.send("leaveGame",{groupId:n.c_groupId,id:n.c_gameId}),gameHub.off("gameUpdate",n.c_gameUpdate),delete n.c_gameUpdate,delete n.c_groupId,delete n.c_gameId)},loadData:function(n,t,i){var r=this,u,f;(i=i.toLowerCase(),n=n.toLowerCase(),t=t.toLowerCase(),u="/host",f=[0,breadcrumbs.length,{text:"Home",url:"/"},{text:"Host",route:u},{text:n,route:u+="/"+encodeURIComponent(n)},{text:"Survey",route:u+="/"+encodeURIComponent(t)},{active:!0,text:"Host Game"}],breadcrumbs.splice.apply(breadcrumbs,f),(n!=r.groupId||i!=r.gameId)&&(r.gameId=i,r.connect(n,i)),n!=r.groupId||t!=r.surveyId)&&(r.survey=r.surveyProblem=null,apiService.loadSurvey(r.groupId=n,r.surveyId=t).then(n=>r.survey=n,n=>r.surveyProblem=n||"Invalid survey"))}},template:`<div class="container-fluid pt-3">
	<div class="card-deck">
		<div class="card">
			<div class="card-body">
